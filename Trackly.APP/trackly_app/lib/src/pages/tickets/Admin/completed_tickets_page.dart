...
class CompletedTicketsPage extends StatefulWidget {
  CompletedTicketsPage({super.key});

  @override
  State<CompletedTicketsPage> createState() => _CompletedTicketsPageState();
}

class _CompletedTicketsPageState extends State<CompletedTicketsPage> {
  final log = logger(CompletedTicketsPage);
  ...
  Future<void> _fetchPage(int pageKey) async {
    ...
    try {
      final newItems =
          await ticketCubit.getCompletedPaginatedTickets(pageKey, _pageSize);
